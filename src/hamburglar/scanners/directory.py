"""Directory scanner module for Hamburglar.

This module provides the DirectoryScanner class which handles file discovery,
...
class DirectoryScanner(BaseScanner):
    """Directory scanner that uses async/await patterns for file scanning.

    The DirectoryScanner walks directories (respecting blacklist/whitelist patterns),
    ...
    This scanner implements the BaseScanner interface and can scan both
    individual files and entire directory trees.
    """
    ...
    def scanner_type(self) -> str:
        ...
        Returns:
            'directory' - identifies this as a directory/file scanner.
        """
        return "directory"
